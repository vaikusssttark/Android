...
import test_app.vaikusstark.testtester.requests.DBHelper;
import test_app.vaikusstark.testtester.requests.SuccessResponse;
import test_app.vaikusstark.testtester.requests.User;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void setLinkToLoginWithAnimation() {
        ...
        return_to_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RegistrationActivity.this, LoginActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
